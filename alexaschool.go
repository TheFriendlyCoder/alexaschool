...
var a = &alexa.Alexa{ApplicationID: "amzn1.ask.skill.5cb6ba49-8028-4dc8-87ac-ba0e3ba100a3", RequestHandler: &HelloWorld{}, IgnoreApplicationID: true, IgnoreTimestamp: true}
...
func (h *HelloWorld) OnIntent(ctx context.Context, request *alexa.Request, session *alexa.Session, ctxPtr *alexa.Context, response *alexa.Response) error {
	...
	case "HelloWorldIntent":
		...
		speechText := "Hello World From Kevin"
